...
const Download = () => {
  return (
    <div className="download-Section py-5 bg-white">
      <div
        className="d-md-flex container justify-content-between"
        data-aos="fade-left"
      ...
      >
        <div className="col-md-6">
          ...
          <h1>
            ...
            <span style={{ color: "red" }}>Watch Offline.</span>
          </h1>

          <div className="d-flex align-items-center mt-4">
            <FaPhotoVideo
              style={{ height: "50px", width: "50px", border: "2px" }}
            ></FaPhotoVideo>
            <div className="ps-4">
              <h4>Enjoy on Your TV.</h4>
              <p>
                Lorem ipsum dolor sit amet, consecetur <br /> adipiscing elit,
